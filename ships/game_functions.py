...
def update_bullets(ai_settings,screen,stats,sb,ship,aliens,bullets):
  ...
  check_collisons(ai_settings,screen,stats,sb,ship,aliens,bullets)

def check_collisons(ai_settings,screen,stats,sb,ship,aliens,bullets):
...
def check_play_button(ai_settings,screen,stats,play_button,ship,aliens,bullets,mouse_x,mouse_y):
  click = play_button.rect.collidepoint(mouse_x,mouse_y)
  if click and not stats.game_active:
